...
public class Color {
  ...
  public void invert() {
    setRed(invertRGBVal(red));
    setGreen(invertRGBVal(green));
    setBlue(invertRGBVal(blue));

  }

  private int invertRGBVal(int rgbVal) {
    return 255 - rgbVal;
  }
  ...
  public void add(Color clr) {
    setRed(red + clr.getRed());
    setGreen(green + clr.getGreen());
    setBlue(blue + clr.getBlue());
  }

  public void divide(int no) {
    setRed(red / no);
    setGreen(green / no);
    setBlue(blue / no);
  }
