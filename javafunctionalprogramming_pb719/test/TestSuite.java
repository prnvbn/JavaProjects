...
public class TestSuite {
  ...
  private static final List<Rectangle> VARIOUS_EMPTY_RECTANGLES = Arrays.asList(
      new Rectangle(new Point(10, 10), 0, 0),
      new Rectangle(new Point(15, 15), 0, 0),
      new Rectangle(new Point(0, 0), 0, 0),
      new Rectangle(new Point(2000, 2000), 0, 0));
  ...
  public void boundedCubeStreamNoException() {
    assertFalse(
        CubeSupplier.boundedCubeStream(0, 50).anyMatch(item -> item == 999));
  }
  ...
  public void emphasiseFirstStringStartingWithPrefix() {
    assertEquals("N/A", StringPrefixes.emphasiseFirstStringStartingWithPrefix(
        Stream.empty(), "Hello"));
    assertEquals("*Java* thinking",
        StringPrefixes.emphasiseFirstStringStartingWithPrefix(
            strings.stream(), "Java"));
    assertEquals("*Haskell* programming",
        StringPrefixes.emphasiseFirstStringStartingWithPrefix(
            strings.stream(), "Haskell"));
    assertEquals("N/A", StringPrefixes.emphasiseFirstStringStartingWithPrefix(
        strings.stream(), "C#"));
  ...
  public void distinctStringsStartingWithPrefix() {
    assertEquals(new ArrayList<>(),
        StringPrefixes.distinctStringsStartingWithPrefix(
            Stream.empty(), "Hello"));
    assertEquals(Arrays.asList(
        ...
        "Java and Haskell: better together?"),
        StringPrefixes
            .distinctStringsStartingWithPrefix(strings.stream(), "Java"));
    assertEquals(Arrays.asList(
        "Haskell programming",
        "Haskell breathing"),
        StringPrefixes
            .distinctStringsStartingWithPrefix(strings.stream(), "Haskell"));
  }
  ...
  // Tests the edge cases for isBelow, isAbove, isLeftOf and isRightOf
  @Test
  public void isSomethingEdgeCases() {
    assertFalse(new Point(1, 1).isBelow(new Point(1, 1)));
    assertFalse(new Point(1, 1).isAbove(new Point(1, 1)));
    assertFalse(new Point(1, 1).isLeftOf(new Point(1, 1)));
    assertFalse(new Point(1, 1).isRightOf(new Point(1, 1)));
  }
  ...
  public void rectangleIntersect4() {
    // Tests if the same rectangle intersects or not
    assertTrue(
        new Rectangle(new Point(3, 3), 10, 10)
            .intersects(new Rectangle(new Point(3, 3), 10, 10)));
    assertTrue(
        new Rectangle(new Point(0, 0), 10, 10)
            .intersects(new Rectangle(new Point(0, 0), 10, 10)));
    // Tests if rectangle sharing a common vertex intersect or not
    assertTrue(
        new Rectangle(new Point(0, 0), 10, 10)
            .intersects(new Rectangle(new Point(0, 0), 3, 3)));
    // Tests if the method works when one rectangle lies inside another rectangle
    assertTrue(
        new Rectangle(new Point(0, 0), 10, 10)
            .intersects(new Rectangle(new Point(1, 1), 3, 3)));
  }
  ...
  public void listScaleByZero() {
    assertTrue(equalRectangleLists(
        VARIOUS_EMPTY_RECTANGLES, ListAlgorithms.scale(VARIOUS_RECTANGLES, 0)));
  }
  // =======================================
  ...
  public void streamScaleByZero() {
    assertTrue(equalRectangleLists(
        VARIOUS_EMPTY_RECTANGLES,
        StreamAlgorithms.scale(VARIOUS_RECTANGLES.stream(), 0)
            .collect(toList())));
  }
  // ==============================================
  ...
  public void rectangleIntersection4() {
    ...
    assertTrue(
        new Rectangle(new Point(3, 3), 10, 10)
            .intersection(new Rectangle(new Point(3, 3), 10, 10)).isPresent());
    assertTrue(
        new Rectangle(new Point(0, 0), 10, 10)
            .intersection(new Rectangle(new Point(0, 0), 10, 10)).isPresent());
    // Tests if rectangle sharing a common vertex intersect or not
    assertTrue(
        new Rectangle(new Point(0, 0), 10, 10)
            .intersection(new Rectangle(new Point(0, 0), 3, 3)).isPresent());
    // Tests if the method works when one rectangle lies inside another rectangle
    assertTrue(
        new Rectangle(new Point(0, 0), 10, 10)
            .intersection(new Rectangle(new Point(1, 1), 3, 3)).isPresent());
