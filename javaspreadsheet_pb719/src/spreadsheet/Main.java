...
public class Main {
   ...
   *
   * <p>This method allows any `input` and `output` streams to be used. You
   * should use these wherever you would normally use `System.in` or
   * `System.out`. This enables the REPL to be tested without interfering with
  ...
  public static void interact(InputStream input, PrintStream output)
    ...
    while (true) {
      ...
      //CASE having assignment of cellLocation
      if (line.contains("=")) {
   ...
   *
   * <p>This method delegates all the work to the interact() method, using the
