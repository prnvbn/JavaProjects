 ...
 *
 * <p>In addition to the two methods listed here, you should override the
 * `toString` method.
 */
public interface Expression {
   ...
   *
   * <p>The provided `EvaluationContext` may be used to lookup the value of
   * other cells.
   */
  double evaluate(EvaluationContext context);

  /**
   * Find all cell locations referenced by this expression (and its
   * subexpressions).
   *
